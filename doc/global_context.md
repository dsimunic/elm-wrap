...
The global context (`GlobalContext`) is a singleton structure initialized at program startup that holds configuration state affecting all commands. Its primary purpose is to detect and track the protocol mode for package management.
